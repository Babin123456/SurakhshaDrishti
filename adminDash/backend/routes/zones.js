...
// Mock Base Transceiver Station (BTS) tower database for GSM E-OTD Simulation
...
// 7. POST /telemetry/eotd-fallback — Process incoming RRLP frames from offline drones
router.post('/telemetry/eotd-fallback', (req, res) => {
  try {
